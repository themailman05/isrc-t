...
function Main() {
  ...
  const onSubmit = async (data: { [x: string]: any }) => {
    ...
    try {
      extra_string = data[EInputType.ISRC] + '/' + data[EInputType.ISWC] + '/' + data[EInputType.FINGERPRINT]
      wallet.minter.setField(MetadataField.Extra, data[EInputType.ISRC] + '/' + data[EInputType.ISWC] + '/' + data[EInputType.FINGERPRINT]);
    } catch (error) {
      console.error(error);
    }
