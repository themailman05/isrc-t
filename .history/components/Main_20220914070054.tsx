...
function Main() {
  ...
  const onSubmit = async (data: { [x: string]: any }) => {
    ...
    const category = `{"ISRC":"${data[EInputType.ISRC]}","ISWC":"${data[EInputType.ISWC]}"}`;
      ...
      <div className="w-full flex flex-col justify-center items-center">
        ...
        <div className="w-full flex flex-col justify-center items-center space-y-8">
          <div className="flex flex-col justify-center items-center space-y-8">
            <MbText className="text-3xl border-gray-100">ISRC-T</MbText>
            <MbText className="text-xl">Industry Standard Recording Code Token</MbText>
            <MbText className="text-l">Industry Standard Recording Code Token</MbText>
          </div>
          <div>
